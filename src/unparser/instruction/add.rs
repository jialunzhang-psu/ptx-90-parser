...
impl PtxUnparser for crate::r#type::instruction::add::DataType {
    fn unparse_tokens(&self, tokens: &mut Vec<PtxToken>) {
        match self {
            ...
            Self::U16x2 => tokens.push(PtxToken::Directive("u16x2".to_string())),
            Self::S16x2 => tokens.push(PtxToken::Directive("s16x2".to_string())),
        }
    }
}

impl PtxUnparser for Add {
    fn unparse_tokens(&self, tokens: &mut Vec<PtxToken>) {
        tokens.push(PtxToken::Identifier("add".to_string()));
