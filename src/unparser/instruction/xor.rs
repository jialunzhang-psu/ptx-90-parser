use crate::{
    lexer::PtxToken,
    r#type::{common::RegisterOperand, instruction::xor::*},
    unparser::*,
};
...
impl PtxUnparser for crate::r#type::instruction::xor::DataType {
...
impl PtxUnparser for Xor {
    fn unparse_tokens(&self, tokens: &mut Vec<PtxToken>) {
        tokens.push(PtxToken::Identifier("xor".to_string()));
