...
pub enum Inst {
    ...
    VaddDtypeAtypeBtypeSat(vop::section_0::VaddDtypeAtypeBtypeSat),
    VsubDtypeAtypeBtypeSat(vop::section_0::VsubDtypeAtypeBtypeSat),
    VabsdiffDtypeAtypeBtypeSat(vop::section_0::VabsdiffDtypeAtypeBtypeSat),
    VminDtypeAtypeBtypeSat(vop::section_0::VminDtypeAtypeBtypeSat),
    VmaxDtypeAtypeBtypeSat(vop::section_0::VmaxDtypeAtypeBtypeSat),
    VaddDtypeAtypeBtypeSatOp2(vop::section_0::VaddDtypeAtypeBtypeSatOp2),
    VsubDtypeAtypeBtypeSatOp2(vop::section_0::VsubDtypeAtypeBtypeSatOp2),
    VabsdiffDtypeAtypeBtypeSatOp2(vop::section_0::VabsdiffDtypeAtypeBtypeSatOp2),
    VminDtypeAtypeBtypeSatOp2(vop::section_0::VminDtypeAtypeBtypeSatOp2),
    VmaxDtypeAtypeBtypeSatOp2(vop::section_0::VmaxDtypeAtypeBtypeSatOp2),
    VaddDtypeAtypeBtypeSat1(vop::section_0::VaddDtypeAtypeBtypeSat1),
    VsubDtypeAtypeBtypeSat1(vop::section_0::VsubDtypeAtypeBtypeSat1),
    VabsdiffDtypeAtypeBtypeSat1(vop::section_0::VabsdiffDtypeAtypeBtypeSat1),
    VminDtypeAtypeBtypeSat1(vop::section_0::VminDtypeAtypeBtypeSat1),
    VmaxDtypeAtypeBtypeSat1(vop::section_0::VmaxDtypeAtypeBtypeSat1),
    Vadd2DtypeAtypeBtypeSat(vop2::section_0::Vadd2DtypeAtypeBtypeSat),
    Vsub2DtypeAtypeBtypeSat(vop2::section_0::Vsub2DtypeAtypeBtypeSat),
    Vavrg2DtypeAtypeBtypeSat(vop2::section_0::Vavrg2DtypeAtypeBtypeSat),
    Vabsdiff2DtypeAtypeBtypeSat(vop2::section_0::Vabsdiff2DtypeAtypeBtypeSat),
    Vmin2DtypeAtypeBtypeSat(vop2::section_0::Vmin2DtypeAtypeBtypeSat),
    Vmax2DtypeAtypeBtypeSat(vop2::section_0::Vmax2DtypeAtypeBtypeSat),
    Vadd2DtypeAtypeBtypeAdd(vop2::section_0::Vadd2DtypeAtypeBtypeAdd),
    Vsub2DtypeAtypeBtypeAdd(vop2::section_0::Vsub2DtypeAtypeBtypeAdd),
    Vavrg2DtypeAtypeBtypeAdd(vop2::section_0::Vavrg2DtypeAtypeBtypeAdd),
    Vabsdiff2DtypeAtypeBtypeAdd(vop2::section_0::Vabsdiff2DtypeAtypeBtypeAdd),
    Vmin2DtypeAtypeBtypeAdd(vop2::section_0::Vmin2DtypeAtypeBtypeAdd),
    Vmax2DtypeAtypeBtypeAdd(vop2::section_0::Vmax2DtypeAtypeBtypeAdd),
    Vadd4DtypeAtypeBtypeSat(vop4::section_0::Vadd4DtypeAtypeBtypeSat),
    Vsub4DtypeAtypeBtypeSat(vop4::section_0::Vsub4DtypeAtypeBtypeSat),
    Vavrg4DtypeAtypeBtypeSat(vop4::section_0::Vavrg4DtypeAtypeBtypeSat),
    Vabsdiff4DtypeAtypeBtypeSat(vop4::section_0::Vabsdiff4DtypeAtypeBtypeSat),
    Vmin4DtypeAtypeBtypeSat(vop4::section_0::Vmin4DtypeAtypeBtypeSat),
    Vmax4DtypeAtypeBtypeSat(vop4::section_0::Vmax4DtypeAtypeBtypeSat),
    Vadd4DtypeAtypeBtypeAdd(vop4::section_0::Vadd4DtypeAtypeBtypeAdd),
    Vsub4DtypeAtypeBtypeAdd(vop4::section_0::Vsub4DtypeAtypeBtypeAdd),
    Vavrg4DtypeAtypeBtypeAdd(vop4::section_0::Vavrg4DtypeAtypeBtypeAdd),
    Vabsdiff4DtypeAtypeBtypeAdd(vop4::section_0::Vabsdiff4DtypeAtypeBtypeAdd),
    Vmin4DtypeAtypeBtypeAdd(vop4::section_0::Vmin4DtypeAtypeBtypeAdd),
    Vmax4DtypeAtypeBtypeAdd(vop4::section_0::Vmax4DtypeAtypeBtypeAdd),
    ...
    VshlDtypeAtypeU32SatMode(vsh::section_0::VshlDtypeAtypeU32SatMode),
    VshrDtypeAtypeU32SatMode(vsh::section_0::VshrDtypeAtypeU32SatMode),
    VshlDtypeAtypeU32SatModeOp2(vsh::section_0::VshlDtypeAtypeU32SatModeOp2),
    VshrDtypeAtypeU32SatModeOp2(vsh::section_0::VshrDtypeAtypeU32SatModeOp2),
    VshlDtypeAtypeU32SatMode1(vsh::section_0::VshlDtypeAtypeU32SatMode1),
    VshrDtypeAtypeU32SatMode1(vsh::section_0::VshrDtypeAtypeU32SatMode1),
